...
from queryhandler.bglg_restem import *
from queryhandler.query_transfer import get_information_response

handler_list = [
    {'check': bl_check_book,             'response': bl_response_book},
    {'check': bl_check_info_trivial,     'response': bl_response_info_trivial},
    {'check': bl_check_info_nearby,      'response': bl_response_info_nearby},
    {'check': bl_check_info_art,         'response': bl_response_info_art},
    {'check': bl_check_list_ticket,      'response': bl_response_list_ticket},
    {'check': bl_check_send_message,     'response': bl_response_send_message},
...
def handle_weixin_request(environ):
    ...
    if environ['REQUEST_METHOD'] == 'GET':
        ...
        try:
            ...
            return get_reply_text_xml(msg, u'BingoLingo!')
